...
function TeamSlider() {
    ...
    const data = [
        { id: 1, position: 'Humar Resources', image: waleed },
        { id: 2, position: 'Front-end Devloper', image: fizba},
        { id: 3, position: 'Front-end Devloper', image: designer },
        { id: 4, position: 'Graphic Designer', image: haider },
    ];
